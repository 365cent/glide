...
from config import EMBEDDINGS_DIR as OUTPUT_DIR, PROCESSED_DIR, CHECKPOINT_DIR, VECTOR_SIZE, MAX_SEQ_LENGTH, BATCH_SIZE, NUM_WORKERS

# BERT-specific configuration
CHECKPOINT_DIR = CHECKPOINT_DIR / "logbert"
OUTPUT_DIR = OUTPUT_DIR / "logbert"
...
def visualize_embeddings(df, output_file=None):
    ...
    plt.title(f't-SNE Visualization: LogBERT Embeddings (All {len(unique_labels)} Classes)', fontsize=14)
...
def main():
    ...
    print("📁 Outputs saved in: embeddings/logbert/")
    print("=" * 60)
